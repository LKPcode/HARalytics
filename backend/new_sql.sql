...
CREATE TABLE IF NOT EXISTS `mydtbs`.`Header` (
  ...
  `private` ENUM("true") NULL DEFAULT NULL,
  `public` ENUM("true") NULL DEFAULT NULL,
  `immutable` ENUM("true") NULL DEFAULT NULL,
  `no-cache` ENUM("true") NULL DEFAULT NULL,
  `no-store` ENUM("true") NULL DEFAULT NULL,
  `max-age` INT(11) NULL DEFAULT NULL,
  `max-stale` INT(11) NULL DEFAULT NULL,
  `min-fresh` INT(11) NULL DEFAULT NULL,
